...
export const constantRouterMap = [
    ...
    children: [
      {
        ...
        meta: {title: '机型列表', icon: 'product-list'}
      },
      /*{
        path: 'orderDetail',
        name: 'orderDetail',
      ...
      },*/
      {
        ...
        meta: {title: '设备列表', icon: 'order-setting'}
      },
      /*{
        path: 'returnApply',
        name: 'returnApply',
  ...
  },
  {
    ...
    redirect: '/sms/coupon',
    name: 'sms',
    meta: {title: '商家管理', icon: 'sms'},
    children: [
      {
        path: 'flash',
        name: 'flash',
        component: () => import('@/views/sms/flash/index'),
        meta: {title: '商家列表', icon: 'sms-flash'}
      },
      {
        path: 'coupon',
        name: 'coupon',
        component: () => import('@/views/sms/coupon/index'),
        meta: {title: '商家类型', icon: 'sms-coupon'}
      },
      /*{
        path: 'flashSession',
        name: 'flashSession',
